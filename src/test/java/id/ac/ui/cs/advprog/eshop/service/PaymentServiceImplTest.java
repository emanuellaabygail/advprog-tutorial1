...
public class PaymentServiceImplTest {
    ...
    void setUp() {
        ...
        Map <String, String> paymentData2 = Map.of("address", "Margonda", "deliveryFee", "9000");
    ...
    void testGetPaymentIfNotFound() {
        doReturn(null).when(paymentRepository).findById("lmao");
        assertNull(paymentService.getPayment("lmao"));
    }
